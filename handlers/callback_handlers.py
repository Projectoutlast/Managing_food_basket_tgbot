...
from keyboard.keyboards import (end_purchase_markup, start_purchase_markup,
...
async def set_up_basket_limit(message: Message, state: FSMContext, basket_limit: dict[str, float]):
...
async def start_purchasing_process(callback: CallbackQuery, state: FSMContext):
    await callback.message.answer(text=f'{COMMAND_TEXT["en"]["purchase_start"]}\n\n'
                                       ...
                                       f'{COMMAND_TEXT["en"]["enter_price"]}',
                                  reply_markup=start_purchase_markup)
...
async def enter_price_purchasing_process(message: Message):
    await message.edit_text(text=f'{COMMAND_TEXT["en"]["total_amount_basket"]}\n'
